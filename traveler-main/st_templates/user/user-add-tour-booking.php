      					...
      					<div class="col-xs-12 col-sm-5-column">
                            <div class="form-group">
                                ...
                                <span class="input-group-addon" id="basic-checkin"><a href="#" class="" id="tour_time" data-toggle="modal" data-target="#calendar_tour_modal"><i class="fa fa-calendar"></i></a></span>
                                    <input readonly data-date-format="jYYYY/jMM/jDD" aria-describedby="basic-checkin" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" autocomplete="off" type="text" name="check_in" id="check_in_tour" value="<?php echo esc_attr($check_in); ?>" class="form-control">
									<!-- Hamzeh -->
                                	<?php
