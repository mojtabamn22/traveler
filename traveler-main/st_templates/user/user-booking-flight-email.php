            ...
            foreach ($posts as $key => $value) {
                ...
                <tr>
                    ...
                    <td class="">
                        <?php
                        $date = $value->check_in;
                        if ($date) echo esc_html__('Depart Date: ', 'traveler') . date_i18n('Y/m/d',strtotime($date)); // Hamzeh ?>
                        <br>
                        <?php $date = $value->check_out;
                        if ($date) echo esc_html__('Return Date: ', 'traveler') . date_i18n('Y/m/d',strtotime($date)); // Hamzeh ?>
                    </td>
