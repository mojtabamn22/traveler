                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="item_booking_detail">
                            ...
                            <?php echo esc_html(date_i18n('Y/m/d', strtotime($order_data['created']))) // Hamzeh?>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="item_booking_detail">
                    ...
                    <div class="col-md-6">
                        <div class="item_booking_detail">
                            ...
                            <?php  echo @date_i18n('Y/m/d'.' '.get_option('time_format'),$check_in_timestamp) // Hamzeh  ?>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="item_booking_detail">
                            <strong><?php esc_html_e("Drop-off Time:",'traveler') ?> </strong>
                            <?php  echo @date_i18n('Y/m/d'.' '.get_option('time_format'),$check_out_timestamp) // Hamzeh  ?>
                        </div>
                    </div>
