            ...
            <?php if(isset($item_data['_st_check_in'])): $data=$item_data['_st_check_in']; ?>
                <li>
                    ...
                    <span class="meta-data">
                        <?php  // Hamzeh
                        echo esc_attr(st()->get_option('use_woocommerce_for_booking', 'off') == 'on' ? date( 'Y/m/d', strtotime( $data ) ) : date_i18n('Y/m/d', strtotime($data)) . ($item_data['_st_starttime'] != '' ? ' - ' . $item_data['_st_starttime'] : ''));
                        ?>
                    </span>
                </li>
                <li>
        ...
        <?php if(isset($item_data['_st_check_in'])): $data=$item_data['_st_check_in']; ?>
            <li>
                ...
                <span class="meta-data"><?php
                    echo esc_attr(st()->get_option('use_woocommerce_for_booking', 'off') == 'on' ? date( 'Y/m/d', strtotime( $data ) ) : date_i18n('Y/m/d', strtotime($data))); // Hamzeh
                    ?>
