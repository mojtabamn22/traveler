			...
			?>
				...
				<div class="date-wrapper clearfix">
					<div class="check-in-wrapper">
						...
						<div class="render check-in-render"><?php echo esc_attr( date_i18n('Y/m/d',strtotime($start)) );// Hamzeh ?></div> - <div class="render check-out-render"><?php echo esc_html( date_i18n('Y/m/d',strtotime($end)) ); // Hamzeh ?></div>
					</div>
				</div>
