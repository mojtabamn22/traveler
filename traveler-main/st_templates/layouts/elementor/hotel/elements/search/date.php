...
<div class="form-group form-date-field form-date-search d-flex align-items-center<?php if($has_icon) echo ' has-icon '; ?>" data-format="<?php echo TravelHelper::getDateFormatMoment() ?>">
    ...
    <div class="date-wrapper">
        <div class="check-in-wrapper">
            ...
            <div class="render check-in-render"><?php echo esc_html(date_i18n('Y/m/d',strtotime($start))); // Hamzeh ?></div><span> - </span><div class="render check-out-render"><?php echo esc_html(date_i18n('Y/m/d',strtotime($end))); // Hamzeh ?></div>
        </div>
    </div>
