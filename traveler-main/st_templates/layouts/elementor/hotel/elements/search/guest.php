<?php
	...
	$room_max  = st()->get_option('hotel_max_room', 14);
?>
        ...
        <li class="item d-flex align-items-center justify-content-between">
            ...
            <div class="select-wrapper">
                <div class="st-number-wrapper d-flex align-items-center justify-content-between">
                    <input type="text" name="room_num_search" value="<?php echo esc_attr($room_num_search); ?>" class="form-control st-input-number" autocomplete="off" readonly data-min="1" data-max="<?php echo esc_attr($room_max);?>"/>
                </div>
            </div>
        </li>
