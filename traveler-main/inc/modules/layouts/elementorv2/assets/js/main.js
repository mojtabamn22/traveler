        ...
        initDateDropdown() {
            ...
            $('.form-date-search').each(function () {
                ...
                checkInOut.daterangepicker(options, function (start, end, label) {
                    var shamsiFormat = 'jYYYY/jMM/jDD'; // Hamzeh
                    if(parent.data('format').includes('hh')) shamsiFormat = 'jYYYY/jMM/jDD, hh:mm A';
                    ...
                    checkInRender.html(start.format(shamsiFormat)).trigger('change');
                    if (parent.hasClass('form-date-travelpayout')) {
                    ...
                    checkOutRender.html(end.format(shamsiFormat)).trigger('change');
                    if (timepicker) {
