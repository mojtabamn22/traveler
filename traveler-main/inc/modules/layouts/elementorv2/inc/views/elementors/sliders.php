    ...
    if(!empty($list_st_sliders)){
        ...
        <div class="st-sliders st-list-slider <?php echo esc_attr($style_slider);?>" <?php echo st_render_html_attributes($attrs);?> >
            <div class="swiper-container">
				...
				if($navigation == 'on'){
					if($style_slider === 'style-2' || $style_slider === 'style-3'){ // Hamzeh
						$html .= '<div class="st-button-prev"><span class="stt-icon stt-icon-arrow-right"></span></div><div class="st-button-next"><span class="stt-icon stt-icon-arrow-left"></span></div>';
					}else {
