...
$cls_package = STAdminPackages::get_inst(); // Hamzeh
$package = $cls_package->get_cart(); // Hamzeh
?>
    <div class="row">
	...
	<div class="payment-form" style="<?php echo $package->package_price == 0 ? 'display: none' : ''; // Hamzeh ?>">
