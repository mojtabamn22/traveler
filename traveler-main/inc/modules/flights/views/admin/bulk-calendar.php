            ...
            <div class="form-group">
                ...
                <div class="form-content">
                    ...
                    for( $i = $year; $i <= $year + 2; $i ++ ):
                        ...
                        ?>
                        <label style="width: 100px;"><input type="checkbox" name="years[]" value="<?php echo esc_attr($i); ?>" style="margin-right: 5px;"><?php echo esc_html($yearJalali); ?></label>
                        <?php
