                ...
                if(!empty($posts)) {
                    ...
                    foreach($posts as $key=>$value) {
                        ...
                        <tr class="<?php if ($i % 2 == 0) echo 'alternate'; ?>">
                            ...
                            <td class="post-title page-title column-title">
                                <?php // Hamzeh
                                $check_in= date_i18n('Y/m/d',strtotime(get_post_meta($post_id, 'check_in', true))); //Hamzeh
                            ...
                            <td class="post-title page-title column-title">
								...
								<?php
                                $check_out= date_i18n('Y/m/d',strtotime(get_post_meta($post_id, 'check_out', true))); //Hamzeh
