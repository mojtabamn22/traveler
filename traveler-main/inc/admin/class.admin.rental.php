...
//                $data['id']=$model->insert($data);
            ...
            {
                echo '<button type="button" id="calendar-bulk-edit" class="option-tree-ui-button button button-primary button-large btn btn-primary btn-sm" style="float: left !important;">' . __( 'Bulk Edit', 'traveler' ) . '</button>'; // Hamzeh
            }
