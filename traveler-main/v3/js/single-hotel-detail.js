            ...
            $('.form-date-search', 'body').each(function () {
                ...
                check_in_out.daterangepicker(options,
                    function (start, end, label) {
                        ...
                        check_in_render.html(start.format('jYYYY/jMM/jDD')).trigger('change'); // Hamzeh
                        check_out_input.val(end.format(parent.data('format'))).trigger('change');
                        $('#tp_hotel .form-date-search .check-out-input').val(end.format('YYYY-MM-DD')).trigger('change');
                        check_out_render.html(end.format('jYYYY/jMM/jDD')).trigger('change'); // Hamzeh
                        if (timepicker) {
                ...
                if (!is_mapbox) {
                    ...
                    $('.st-map', body).each(function () {
                        var parent = $(this),
                            ...
                            mapIcon = mapEl.data('icon'),
                            street_views = mapEl.data('street_views');
                        if(!lat_center && !lng_center) return;
                    ...
                    $('.st-map-box', body).each(function () {
                        ...
                        if (!$('#st-content-wrapper').hasClass('singe-hotel-layout-4')) {
                            ...
                            if(mapData && mapData[0] && mapData[0].lat && mapData[0].lng) { // hamzeh
