    ...
    $('.st_add_booking_tour', body).each(function () {
        ...
        check_in_out_input.daterangepicker(options,
            function (start, end, label, elmDate) {
                ...
                check_in_render.html(start.format('jYYYY/jMM/jDD')); // Hamzeh
                check_out_render.html(end.format('jYYYY/jMM/jDD')); // Hamzeh
                if (start.format(parent.data('format')).toString() == end.format(parent.data('format')).toString()) {
                    sts_checkout_label.hide();
                } else {
                    sts_checkout_label.show();
                }
                date = moment(start.format(parent.data('format'))).format('jYYYY/jMM/jDD'); // Hamzeh
                date_end = moment(end.format(parent.data('format'))).format('jYYYY/jMM/jDD'); // Hamzeh
