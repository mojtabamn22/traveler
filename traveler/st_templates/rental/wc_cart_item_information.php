...
<p class="booking-item-description">
	...
	<?php echo esc_html(st()->get_option('use_woocommerce_for_booking', 'off') == 'on' ? date( 'Y/m/d', strtotime( $st_booking_data['check_in'] ) ) : date_i18n('Y/m/d', strtotime($st_booking_data['check_in']))); ?>
	-
	<?php echo esc_html(st()->get_option('use_woocommerce_for_booking', 'off') == 'on' ? date( 'Y/m/d', strtotime( $st_booking_data['check_out'] ) ) : date_i18n('Y/m/d', strtotime($st_booking_data['check_out']))); ?>
</p>
