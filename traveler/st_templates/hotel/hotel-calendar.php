...
<div id="form-bulk-edit" class="form-bulk-edit-activity-tour">
    ...
    <?php endif; ?>
        ...
        <p>لطفا از این فرم فقط برای ناموجود کردن به صورت کلی استفاده کنید و برای مشخص کردن موجودی از فرم کنار تقویم کمک بگیرید</p>
            ...
            <div class="form-group">
                ...
                <div class="form-content">
                    ...
                    for( $i = $year; $i <= $year + 2; $i ++ ):
                        ...
                        ?>
                        <label style="width: 100px;"><input type="checkbox" name="years[]" value="<?php echo esc_html($i); ?>" style="margin-right: 5px;"><?php echo esc_html($yearJalali); ?></label>
