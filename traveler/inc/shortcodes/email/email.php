            ...
            if ($post_type == 'st_tours') {
                ...
                if ($tour_price_type == 'fixed_depart') {
                    ...
                    if ($tour_type == 'daily_tour') {
                        $return .= date_i18n(TravelHelper::getDateFormat(), strtotime(get_post_meta($order_id, 'check_in', true)));
                        $return .= "<br/>";
                        ...
                        $return .= date_i18n(TravelHelper::getDateFormat(), strtotime(get_post_meta($order_id, 'check_in', true)));
                        $return .= " - ";
                        $return .= date_i18n(TravelHelper::getDateFormat(), strtotime(get_post_meta($order_id, 'check_out', true)));
                    }
                }
            }
            if ($post_type == 'st_activity') {
