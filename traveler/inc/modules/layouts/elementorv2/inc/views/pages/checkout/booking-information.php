...
<div class="booking-success-notice">
    <div class="row">
        <div class="col-lg-8 col-12 col-left">
            <div class="success-icon"><span <?php echo (get_post_meta($order_code, 'payment_method', true) == 'st_submit_form' || get_post_meta($order_code, 'status', true) === 'complete' ? '' : 'style="background: #d61e1e;"'); ?> class="stt-icon stt-icon-check"></span></div> <!-- Hamzeh -->
                ...
                <p class="line1">
                    ...
                    if (get_post_meta($order_code, 'payment_method', true) == 'st_submit_form') {
                        ...
                        if(get_post_meta($order_code, 'status', true) === 'complete' ){
                            ...
                            // echo __('Your order was submitted successfully!' , 'traveler' ) ;
                            echo __('پرداخت با موفقیت انجام نشده و رزرو ناتمام است.' , 'traveler' ) ;
                        }

                    ?>
                </p>
                <?php if(get_post_meta($order_code, 'payment_method', true) == 'st_submit_form' || get_post_meta($order_code, 'status', true) === 'complete') { ?>
                    <p class="line2">
                        <?php _e('Booking details have been sent to: ','traveler'); ?>
                        <span><?php echo get_post_meta($order_code, 'st_email', true) ?></span>
                    </p>
                <?php } ?>
            </div>
        </div>
        <div class="col-lg-4 col-12 col-right">
            <ul class="booking-info-detail">
                ...
                <li><span><?php echo __('Booking Date:', 'traveler'); ?></span> <?php echo date_i18n('Y/m/d',strtotime($order_item->post_date)); // Hamzeh ?></li>
