    ...
    <div class="date-wrapper clearfix">
        <div class="date-item-wrapper d-block w-100 checkin">
            <div class="item-inner">
                ...
                <div class="render check-in-render"><?php echo esc_html(date_i18n('Y/m/d',strtotime($pick_up_datetext))); // Hamzeh ?></div>
            </div>
        </div>
        <div class="date-item-wrapper d-block w-100 checkout">
            <div class="item-inner">
                <label><?php echo __('Drop-off', 'traveler'); ?></label>
                <div class="render check-out-render"><?php echo esc_html(date_i18n('Y/m/d',strtotime(datetime: $drop_off_datetext))).', '. esc_html($drop_off_time); // Hamzeh ?></div>
                <span>
            </div>
        </div>
    </div>
