                ...
                'fields' => [
                    ...
                    [
                        ...
                        'settings' => [
                            ...
                            [
                                'id' => 'car_time',
                                'label' => 'مدت زمان با ماشین',
                                'desc' => 'مدت زمانی که نیاز است تا با ماشین برای رسیدن به مقصد طی شود.',
                                'type' => 'text'
                            ],
                            [
                                'id' => 'walking_distance',
                                'label' => 'مدت زمان پیاده',
                                'desc' => 'مدت زمانی که نیاز است تا با پیاده  برای رسیدن به مقصد طی شود.',
                                'type' => 'text'
                            ],
                            [
                                'id' => 'distance',
                                'label' => 'فاصله هتل تا مقصد',
                                'desc' => 'میزان مسافت هتل تا مقصد به صورت متر',
                                'type' => 'text'
                            ],
                        ]
                    ],
