...
//                $data['id']=$model->insert($data);
        ...
        { // Hamzeh
            echo '<button type="button" id="calendar-bulk-edit" class="option-tree-ui-button button button-primary button-large btn btn-primary btn-sm" style="float: left !important;">' . __('Bulk Edit', 'traveler') . '</button>';
        }
            ...
            $this->metabox[] = [
                ...
                'fields' => [
                    ...
                    [
                        ...
                        'id' => 'room_description',
                        'type' => 'textarea',
						'desc' => __('This option can be used for only WPBakery Single Hotel with Room Layout', 'traveler'),
                        'std' => ''
                    ],
                    [
