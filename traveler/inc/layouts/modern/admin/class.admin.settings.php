...
class ST_Admin_Settings extends STAdmin
{
    ...
    public function __registerPage()
    {
            if (class_exists('Envato_WP_Toolkit')) {
                ...
                $pos = 3;
            add_menu_page('Traveler', 'تراولر', 'manage_options', 'st_traveler_options', [$this, '__overviewPage'], 'dashicons-st-traveler', $pos);
    ...
    public function __advanceSettings()
    {
        return [
            [
                ...
                ', 'traveler') . '<span style="color: red">این فرمت تاریخ تغییر ندید لطفا. مشکل در روند رزرو پیش  میاد.</span>',
                'v_hint' => 'yes'
            ],
            [
                'id' => 'time_format',
