                ...
                foreach ( $posts as $key => $value ) {
                    ...
                    <tr class="<?php if ( $i % 2 == 0 ) echo 'alternate'; ?>">
                        ...
                        <td class="post-title page-title column-title">
                            ...
                            <?php
                                $check_in  = st()->get_option('use_woocommerce_for_booking', 'off') == 'on' ?  get_post_meta( $post_id, 'check_in', true ) : date_i18n('Y/m/d', strtotime(get_post_meta( $post_id, 'check_in', true )) ); // Hamzeh
