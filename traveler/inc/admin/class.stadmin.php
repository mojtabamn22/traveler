...
if (!class_exists('STAdmin')) {
    ...
    class STAdmin {
        ...
        function admin_enqueue_scripts($hook) {
            ...
            wp_deregister_script( 'moment' ); // Hamzeh
            ...
            wp_enqueue_script('st-custom-admin', get_template_directory_uri() . '/js/admin/custom-admin.js', ['jquery', 'datepicker-persian-js'], null, true);
