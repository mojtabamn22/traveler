        ...
        class STHotel extends TravelerObject
        {
            ...
            function do_add_to_cart()
            {
                ...
                if ( !HotelHelper::check_day_cant_order( $room_origin, $checkin_ymd, $checkout_ymd, $room_num_search, $adult_number, $child_number ) ) {
                    STTemplate::set_message( sprintf( __( 'This room is not available from %s to %s.', 'traveler' ), date_i18n('Y/m/d',strtotime($$checkin_ymd)), date_i18n('Y/m/d',strtotime($$checkin_ymd)) ), 'danger' );
                    $pass_validate = false;
...
//                }
            ...
            function _get_where_query( $where )
            {
                ...
                if ( isset( $_REQUEST[ 'discount_only' ] ) && !empty( $_REQUEST[ 'discount_only' ] ) ) {
